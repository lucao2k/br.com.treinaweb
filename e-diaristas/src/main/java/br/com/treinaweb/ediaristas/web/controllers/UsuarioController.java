...
public class UsuarioController {
    ...
    public String cadastrar(@Valid @ModelAttribute("cadastroForm") UsuarioCadastroForm cadastroForm, 
        ...
        } catch (ValidacaoException e) { //Ao invez de validar senha e email repetindo no codigo
            result.addError(e.getFieldError()); //elas herdam da ValidacaoException, entao usamos somente ela.
            return "admin/usuario/cadastro-form";
        } 
    ...
    public String alterarSenha(
        @Valid 
        @ModelAttribute("alterarSenhaForm") 
        AlterarSenhaForm alterarSenhaForm, 
