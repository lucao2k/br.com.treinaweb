...
public class ServicoController {
    ...
    public String cadastrar(@Valid @ModelAttribute("form") ServicoForm form, BindingResult resultado, RedirectAttributes attrs) {
    ...
    public String editar(@PathVariable Long id, @Valid @ModelAttribute("form") ServicoForm form, BindingResult resultado, RedirectAttributes attrs) {
        if (resultado.hasErrors()) {
            return "admin/servico/form";
        }
    ...
    //Abaixo servirá tanto para página de Cadastrar quanto de Edição, não sendo necessário repetir o codigo em cadastrar e editar.
